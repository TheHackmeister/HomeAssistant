...
class CompensationConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_configure(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema(
                {
                    # TODO: Make cv.entity_id validate like cv.string, but also load the ha-entity-picker object?
...
class OptionsFlowHandler(config_entries.OptionsFlow):
    ...
    async def async_step_add_calibration_datapoints(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema(
                {
                    # TODO: I couldn't figure out how to make this accept 0.
