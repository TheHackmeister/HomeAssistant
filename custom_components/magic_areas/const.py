...
CONF_FEATURE_CLOSED_PRESENCE_HOLD = "closed_presence_hold"
...
CONF_PRESENCE_HOLD_ENTITY = "presence_hold_entity"
CONF_PRESENCE_HOLD_STATE, DEFAULT_PRESENCE_HOLD_STATE = "presence_hold_state", STATE_ON
